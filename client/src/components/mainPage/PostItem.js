...
class PostItem extends Component {
    state = {
        user: this.props.authenticatedUser && this.props.authenticatedUser.id,
        title: "",
        tradeOnly: false,
        price: 0,
        category: "",
    ...
    render() {
        ...
        return (
            ...
            <div className="post-item__overlay" onClick={this.props.postItemForm && this.props.togglePostItem}>asdf</div>
                    ...
                    <div className="post-item__form">
                        <div className="post-item__form-row-1">
                            <div className="post-item__form-title">
                                ...
                                <input name={"title"} type="text" className="post-item__form-title-input" placeholder={"Headline"}
                        ...
                        <div className="post-item__form-row-2">
                            ...
                            <div className="post-item__form-image">
                                ...
                                <input name={"imageUrl"} type="text" className={'post-item__form-image-input'} placeholder={"Image Url"} value={this.state.imageUrl} onChange={this.onChange}/>
                            </div>
                        </div>
                        <div className="post-item__form-row-3">
                            <div className="post-item__form-items-wanted">
                                ...
                                <input name={"itemsWanted"} type="text" className={'post-item__form-items-wanted-input'}
                                       placeholder={"Items Wanted"} value={this.state.itemsWanted} onChange={this.onChange}/>
                            </div>
                            <div className="post-item__form-price">
                                ...
                                <input name={"price"} type="number" className={"post-item__form-price-input"}
                                       placeholder={"Price with trade"} onChange={this.onChange} value={this.state.price}/>
                            </div>
                        </div>
                        <div className="post-item__form-row-4">
                            <div className="post-item__form-description">
                                ...
                                <textarea name="description" id="" cols="30" rows="10" resize={"none"}
                                          className={'post-item__form-description-input'} value={this.state.description} onChange={this.onChange}></textarea>
                            </div>
...
export default withData(withRouter(PostItem));